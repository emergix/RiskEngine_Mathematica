...
If[initialTailFlag>0,sum=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoef0,0,InitialTailPosition]];If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" sum pre-initiale=",sum]];sum+=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoef0,InitialTailPosition,period0]],sum=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoef0,0,period0]]];
If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" sum initiale=",sum]];
increment=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoefn,period0+i*periodn,period0+(i+1)*periodn]];
If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print["kini=",period0+i*periodn," increment initial=",increment]];
If[(Abs[increment[[1]]]>\[Epsilon])&&(i<imax),sum+=increment;i+=1];
While[(Abs[increment[[1]]]>\[Epsilon])&&(i<imax),
increment=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoefn,period0+i*periodn,period0+(i+1)*periodn]];sum+=increment;i+=1;If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" i=",i," Kini=",period0+i*periodn," increment =",increment]]];
If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" Sum finale=",sum]];
...
If[initialTailFlag>0,sum=CoeffBasedIntegrate[Func,LegendreCoeffsFromLegendre[LegendreCoef0,0,InitialTailPosition]];If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" sum pre-initiale=",sum]];
...
;sum+=increment;i+=1;If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" i=",i," Kini=",period0+i*periodn," increment =",increment]]];
If[printflag\[Equal]8|| MemberQ[printflag,8] ,Print[" Sum finale=",sum]];
{{i,Abs[increment[[1]]],{If[(Abs[increment[[1]]]\[LessEqual]\[Epsilon]),"increment<=\[Epsilon] :"<>ToString[Abs[increment[[1]]]]],If[(i<imax),"i>imax :"<>ToString[i]],If[(period0+i*periodn>kmax),"period0+i*periodn>kmax:"<>ToString[period0+i*periodn]]}},sum}]
*)
